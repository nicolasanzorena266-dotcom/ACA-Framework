...
class RuntimeEndpointAPI:
    ...
    endpoints = (
        ...
        RuntimeEndpoint("GET", "/public-demo/usability", "Return public demo usability contract.", "public_demo.usability.read"),
        RuntimeEndpoint("GET", "/public-demo/usability/validate", "Validate public demo usability contract.", "public_demo.usability.validate"),
    ...
    def public_demo_usability(self, *, public_base_url: str = "https://aca-public-web-demo.onrender.com") -> Dict[str, Any]:
        return build_public_demo_usability(public_base_url=public_base_url)

    def validate_public_demo_usability(
        self,
        *,
        report: Mapping[str, Any] | None = None,
    ) -> Dict[str, Any]:
        return validate_public_demo_usability(report=report)
    ...
    def _local_requester(
        ...
        *,
        ...
        if method == "GET" and path == "/public-demo/usability":
            return self.public_demo_usability(public_base_url=params.get("public_base_url") or "https://aca-public-web-demo.onrender.com")
